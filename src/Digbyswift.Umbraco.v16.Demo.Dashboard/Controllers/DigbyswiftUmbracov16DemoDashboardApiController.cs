...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Digbyswift.Umbraco.v16.Demo.Dashboard")]
    public class DigbyswiftUmbracov16DemoDashboardApiController : DigbyswiftUmbracov16DemoDashboardApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public DigbyswiftUmbracov16DemoDashboardApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
