...
namespace Digbyswift.Umbraco.v16.Demo.Dashboard.Composers
{
    public class DigbyswiftUmbracov16DemoDashboardApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Digbyswift Umbracov 16Demo Dashboard Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<DigbyswiftUmbracov16DemoDashboardOperationSecurityFilter>();
            });
        }

        public class DigbyswiftUmbracov16DemoDashboardOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Digbyswift.Umbraco.v16.Demo.Dashboard.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
