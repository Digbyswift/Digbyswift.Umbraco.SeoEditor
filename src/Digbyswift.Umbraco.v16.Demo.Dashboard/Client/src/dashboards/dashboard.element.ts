...
import { DigbyswiftUmbracov16DemoDashboardService, UserModel } from "../api/index.js";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await DigbyswiftUmbracov16DemoDashboardService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await DigbyswiftUmbracov16DemoDashboardService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await DigbyswiftUmbracov16DemoDashboardService.whatsMyName();
